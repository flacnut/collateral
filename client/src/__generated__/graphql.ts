...
export type Query = {
  ...
  getLinkTokenForAccount: LinkTokenResult;
  ...
  getTransactionsByTags: Array<GroupedTransactions>;
...
export type QueryGetLinkTokenForAccountArgs = {
  accountId: Scalars['String'];
};
...
export type QueryGetTransactionsByTagsArgs = {
  classifications?: InputMaybe<Array<TransactionClassification>>;
...
export type GetAccountQuery = { __typename?: 'Query', getAccount: { __typename?: 'Account', name: string, officialName?: string | null, status: string, type: string, latestTransaction?: { __typename?: 'CoreTransaction', id: string, amount: number, amountCents: number, classification?: TransactionClassification | null, date: string, description: string, tags?: Array<{ __typename?: 'Tag', name: string }> | null } | null, latestBalance: { __typename?: 'AccountBalance', availableCents: number, balanceCents: number, lastUpdateDate: string, limitCents: number }, institution: { __typename?: 'Institution', logo?: string | null, primaryColor?: string | null, name: string } } };
...
export type GetTransactionsByAccountQuery = { __typename?: 'Query', getTransactions: Array<(
...
export type GetLinkTokenForAccountQueryQueryVariables = Exact<{
  accountId: Scalars['String'];
}>;


export type GetLinkTokenForAccountQueryQuery = { __typename?: 'Query', getLinkTokenForAccount: { __typename?: 'LinkTokenResult', token?: string | null } };
...
export type GetTransactionsByTagsQueryVariables = Exact<{
  tags: Array<Scalars['String']> | Scalars['String'];
  classifications?: InputMaybe<Array<TransactionClassification> | TransactionClassification>;
}>;


export type GetTransactionsByTagsQuery = { __typename?: 'Query', getTransactionsByTags: Array<{ __typename?: 'GroupedTransactions', key: string, transactions: Array<(
      { __typename?: 'CoreTransaction', account: { __typename?: 'Account', id: string, name: string } }
      & { ' $fragmentRefs'?: { 'CorePartsFragment': CorePartsFragment } }
    )> }> };

export type CorePartsFragment = { __typename?: 'CoreTransaction', id: string, accountId: string, description: string, amountCents: number, amount: number, date: string, currency?: string | null, classification?: TransactionClassification | null, tags?: Array<{ __typename?: 'Tag', name: string }> | null } & { ' $fragmentName'?: 'CorePartsFragment' };
...
export type GetDuplicatesQuery = { __typename?: 'Query', getDuplicates: Array<{ __typename?: 'GroupedTransactions', key: string, transactions: Array<(
      { __typename?: 'CoreTransaction', account: { __typename?: 'Account', id: string, name: string }, tags?: Array<{ __typename?: 'Tag', name: string }> | null }
      & { ' $fragmentRefs'?: { 'CorePartsFragment': CorePartsFragment } }
    )> }> };
...
export type DeletePendingMutationVariables = Exact<{ [key: string]: never; }>;


export type DeletePendingMutation = { __typename?: 'Mutation', deletePending: boolean };

export type RefreshPlaidItemsQueryVariables = Exact<{ [key: string]: never; }>;


export type RefreshPlaidItemsQuery = { __typename?: 'Query', refreshPlaidItems: boolean };
...
export const CorePartsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"CoreParts"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"CoreTransaction"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"accountId"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"amountCents"}},{"kind":"Field","name":{"kind":"Name","value":"amount"}},{"kind":"Field","name":{"kind":"Name","value":"date"}},{"kind":"Field","name":{"kind":"Name","value":"currency"}},{"kind":"Field","name":{"kind":"Name","value":"classification"}},{"kind":"Field","name":{"kind":"Name","value":"tags"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]} as unknown as DocumentNode<CorePartsFragment, unknown>;
...
export const GetLinkTokenForAccountQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getLinkTokenForAccountQuery"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"accountId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getLinkTokenForAccount"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"accountId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"accountId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"token"}}]}}]}}]} as unknown as DocumentNode<GetLinkTokenForAccountQueryQuery, GetLinkTokenForAccountQueryQueryVariables>;
...
export const GetTransactionsByTagsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getTransactionsByTags"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"tags"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"classifications"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"TransactionClassification"}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getTransactionsByTags"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"classifications"},"value":{"kind":"Variable","name":{"kind":"Name","value":"classifications"}}},{"kind":"Argument","name":{"kind":"Name","value":"tags"},"value":{"kind":"Variable","name":{"kind":"Name","value":"tags"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"transactions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"CoreParts"}},{"kind":"Field","name":{"kind":"Name","value":"account"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]}},...CorePartsFragmentDoc.definitions]} as unknown as DocumentNode<GetTransactionsByTagsQuery, GetTransactionsByTagsQueryVariables>;
...
export const DeleteTransactionsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"deleteTransactions"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"transactionIds"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteTransactions"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"transactionIds"},"value":{"kind":"Variable","name":{"kind":"Name","value":"transactionIds"}}}]}]}}]} as unknown as DocumentNode<DeleteTransactionsMutation, DeleteTransactionsMutationVariables>;
...
export const DeletePendingDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"deletePending"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deletePending"}}]}}]} as unknown as DocumentNode<DeletePendingMutation, DeletePendingMutationVariables>;
export const RefreshPlaidItemsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"refreshPlaidItems"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"refreshPlaidItems"}}]}}]} as unknown as DocumentNode<RefreshPlaidItemsQuery, RefreshPlaidItemsQueryVariables>;
