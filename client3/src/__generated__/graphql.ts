...
export type GetItemsQuery = {
  ...
  getItems: Array<{
    ...
    accounts: Array<
      {
        __typename?: 'PlaidAccount';
        latestBalance: { __typename?: 'PlaidAccountBalance' } & {
          ' $fragmentRefs'?: { BalancePartsFragment: BalancePartsFragment };
        };
        latestTransaction?: { __typename?: 'CoreTransaction'; date: string } | null;
        institution: { __typename?: 'PlaidInstitution' } & {
...
} & { ' $fragmentName'?: 'AccountPartsFragment' };

export type BalancePartsFragment = {
  __typename?: 'PlaidAccountBalance';
  balanceCents: number;
  limitCents: number;
  lastUpdateDate: string;
  availableCents: number;
} & { ' $fragmentName'?: 'BalancePartsFragment' };

export type InstitutionPartsFragment = {
  __typename?: 'PlaidInstitution';
  id: string;
  url?: string | null;
  name: string;
...
} & { ' $fragmentName'?: 'InstitutionPartsFragment' };

export type GetTokenQueryVariables = Exact<{ [key: string]: never }>;

export type GetTokenQuery = {
  __typename?: 'Query';
  getLinkToken: { __typename?: 'LinkTokenResult'; token?: string | null; error?: string | null };
};
...
export type SetPlaidLinkResponseMutation = {
  __typename?: 'Mutation';
  setPlaidLinkResponse: { __typename?: 'PlaidItem'; id: string; institutionId: string };
};
...
export type GetBasicTransactionsQuery = {
  __typename?: 'Query';
  getTransactions: Array<
    | ({
        ...
        ' $fragmentRefs'?: {
          CoreHoldingTransactionPartsFragment: CoreHoldingTransactionPartsFragment;
        };
      })
    | ({
        __typename: 'PlaidTransaction';
...
export type CorePlaidTransactionPartsFragment = {
  __typename?: 'PlaidTransaction';
  id: string;
  accountId: string;
  description: string;
...
} & { ' $fragmentName'?: 'CorePlaidTransactionPartsFragment' };

export type CoreHoldingTransactionPartsFragment = {
  __typename?: 'PlaidHoldingTransaction';
  id: string;
  accountId: string;
  description: string;
  ...
  currency?: string | null;
  classification?: TransactionClassification | null;
} & { ' $fragmentName'?: 'CoreHoldingTransactionPartsFragment' };

export const AccountPartsFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'AccountParts' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'PlaidAccount' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
...
} as unknown as DocumentNode<AccountPartsFragment, unknown>;
export const BalancePartsFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'BalanceParts' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'PlaidAccountBalance' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          { kind: 'Field', name: { kind: 'Name', value: 'balanceCents' } },
          { kind: 'Field', name: { kind: 'Name', value: 'limitCents' } },
          { kind: 'Field', name: { kind: 'Name', value: 'lastUpdateDate' } },
          { kind: 'Field', name: { kind: 'Name', value: 'availableCents' } },
        ],
      },
    },
  ],
} as unknown as DocumentNode<BalancePartsFragment, unknown>;
export const InstitutionPartsFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'InstitutionParts' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'PlaidInstitution' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          { kind: 'Field', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<InstitutionPartsFragment, unknown>;
export const CorePlaidTransactionPartsFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'CorePlaidTransactionParts' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'PlaidTransaction' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          { kind: 'Field', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<CorePlaidTransactionPartsFragment, unknown>;
export const CoreHoldingTransactionPartsFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'CoreHoldingTransactionParts' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'PlaidHoldingTransaction' },
      },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
...
} as unknown as DocumentNode<CoreHoldingTransactionPartsFragment, unknown>;
export const GetItemsDocument = {
  ...
  definitions: [
              ...
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                {
                  ...
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'FragmentSpread', name: { kind: 'Name', value: 'AccountParts' } },
                      {
                        kind: 'Field',
    ...
    ...AccountPartsFragmentDoc.definitions,
    ...BalancePartsFragmentDoc.definitions,
    ...InstitutionPartsFragmentDoc.definitions,
  ],
...
export const SetPlaidLinkResponseDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'setPlaidLinkResponse' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'plaidLinkResponse' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'PlaidLinkResponse' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'plaidLinkResponse' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'plaidLinkResponse' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
...
} as unknown as DocumentNode<SetPlaidLinkResponseMutation, SetPlaidLinkResponseMutationVariables>;
export const DeletAccountDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'deletAccount' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
...
} as unknown as DocumentNode<DeletAccountMutation, DeletAccountMutationVariables>;
export const GetBasicTransactionsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
            ...
            selectionSet: {
              ...
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: '__typename' } },
                {
                  ...
                  typeCondition: {
                    kind: 'NamedType',
                    name: { kind: 'Name', value: 'PlaidTransaction' },
                  },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
    ...
    ...CorePlaidTransactionPartsFragmentDoc.definitions,
    ...CoreHoldingTransactionPartsFragmentDoc.definitions,
  ],
} as unknown as DocumentNode<GetBasicTransactionsQuery, GetBasicTransactionsQueryVariables>;
